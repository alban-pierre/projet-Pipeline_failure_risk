...
[train_i, test_i] = train_test_sets(n, testsize, nb_test);

scores = zeros(2, nb_test);
...
for i=1:size(train_i,2)
	...
	[scores(1,i), auc{1,i}] = compute_auc(prediction_train, trainy);
	[scores(2,i), auc{2,i}] = compute_auc(prediction_test, testy);
end
